...
if (empty($star_rating)) {
	register_error(elgg_echo("agora:comments:rating:blank"));
	forward(REFERER);
}
...
if ($comment_guid) {
	...
	$annotation_sr = create_annotation($entity->guid, AGORA_STAR_RATING_ANNOTATION, $star_rating, "",	$user->guid, $entity->access_id);
