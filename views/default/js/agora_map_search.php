elgg.provide('elgg.agora_map_view');

elgg.agora_map_view.init = function() {
    ...
    $('#nearby_btn').click(function(){
        ...
        var s_category = $('#s_category').val();	// agora
        var s_action = $('#s_action').val();
        var s_price_min = $('#s_price_min').val();
        var s_price_max = $('#s_price_max').val();
...
elgg.register_hook_handler('init', 'system', elgg.agora_map_view.init);
