...
<div>
    ...
    <span class='agora_custom_fields_more_info' id='more_info_title' title='<?php echo elgg_echo('agora:add:title:note'); ?>'></span>
...
<div class="digitalfile_frame">
	<div id="digital_file_box">
		<?php 
			if (get_digital_filename($guid)) echo elgg_echo('agora:add:digital:alreadyuploaded', array(get_digital_filename($guid))); 
		?>
